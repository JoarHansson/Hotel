...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,400;0,700;0,800;1,400;1,700;1,800&family=Lilita+One&family=Lora:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="/public/style.css">
</head>

<body class="h-full relative">
  <div class="absolute top-0 bottom-0 left-0 right-0 bg-[url('/assets/ice.jpg')] bg-center bg-auto opacity-50 -z-10"></div>
